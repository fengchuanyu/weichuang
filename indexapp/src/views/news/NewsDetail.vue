  ...
  <div>
    <div id="ndcontainer">
        ...
        <div class="content">
            ...
            中文名 Web前端开发工程师 外文名 Web Front-end developer 核心技术HTML、CSS、JS、C++ 职    业网页设计/小程序/WebAPP开发
            <img src="" alt="">
            目录
            1 前端介绍
            2 核心技术
            ...
            总结(:3[▓▓]快醒醒开学了﻿ε≡٩(๑>₃<)۶ 一心向学*:ஐ٩(๑´ᵕ`)۶ஐ:* 学习使我进步 新闻id:{{nowIn}}
        ...
        <div class="foot">
            <ul class="clearfix">
                <li>
                    ...
                    <span @click="upPage() " v-bind:class="{active:upstop}" v-on:click="changeColor()">上一篇</span>
                </li>
                <li>
                    <span @click="nextPage()" v-on:click="changeColor()"  v-bind:class="{active:dowstop}">下一篇</span>
...
export default {
  ...
  methods:{
      ...
      nextPage(){
          if(this.nowIn+1<=this.dataList.length)
          {
              this.nowIn++;    
          }
      },
      ...
      lastPage(){
          this.nowIn=this.dataList.length;
          this.dowstop=true;
          this.upstop=false ;
      },
      changeColor(){
          ...
          else if(this.nowIn==this.dataList.length)
          {
            this.dowstop=true;
            this.upstop=false ;
          }
